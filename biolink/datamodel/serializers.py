...
association = api.model('Association', {
    ...
    'subject_eq': fields.List(fields.Nested(annotation_extension, description='Equivalent identifiers to subject node')),
    ...
    'object_eq': fields.List(fields.Nested(annotation_extension, description='Equivalent identifiers to object node')),
