...
association = api.model('Association', {
    ...
    'evidence_graph': fields.Nested(bbop_graph, description='An indirect association is a join between two or more direct associations, e.g. gene to disease via ortholog. We record the full set of associations as a graph object'),
...
gene = api.inherit('Gene', bio_object, {
    ...
    'homology_associations': fields.List(fields.Nested(association), description='orthology and paralogy associations for this gene'),
    'function_associations': fields.List(fields.Nested(association), description='GO associations for wild type gene'),
    'pathway_associations': fields.List(fields.Nested(association), description='Associations to pathways in which this gene is involved, including LEGO models'),
